...
namespace DataverseModel
{
	...
	public partial class Incident : Microsoft.Xrm.Sdk.Entity
	{
		...
		public partial class Fields
		{
			...
			public const string msdyn_FunctionalLocationName = "msdyn_functionallocationname";
		...
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("msdyn_functionallocationname")]
		public string msdyn_FunctionalLocationName
		{
			get
			{
				if (this.FormattedValues.Contains("msdyn_functionallocation"))
				{
					return this.FormattedValues["msdyn_functionallocation"];
				}
				else
				{
					return default(string);
		...
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("msdyn_incidenttypename")]
		public string msdyn_IncidentTypeName
		{
			get
			{
				if (this.FormattedValues.Contains("msdyn_incidenttype"))
				{
					return this.FormattedValues["msdyn_incidenttype"];
				}
				else
				{
					return default(string);
		...
		public DataverseModel.Entitlement entitlement_cases
		{
			get
			{
				return this.GetRelatedEntity<DataverseModel.Entitlement>("entitlement_cases", null);
			}
			set
			{
				this.SetRelatedEntity<DataverseModel.Entitlement>("entitlement_cases", null, value);
			}
		}
		...
		public DataverseModel.SLA manualsla_cases
		{
			get
			{
				return this.GetRelatedEntity<DataverseModel.SLA>("manualsla_cases", null);
			}
			set
			{
				this.SetRelatedEntity<DataverseModel.SLA>("manualsla_cases", null, value);
			}
		}
		...
		public DataverseModel.Product product_incidents
		{
			get
			{
				return this.GetRelatedEntity<DataverseModel.Product>("product_incidents", null);
			}
			set
			{
				this.SetRelatedEntity<DataverseModel.Product>("product_incidents", null, value);
			}
		}
		...
		public DataverseModel.SLA sla_cases
		{
			get
			{
				return this.GetRelatedEntity<DataverseModel.SLA>("sla_cases", null);
			}
		}
		...
		public DataverseModel.Subject subject_incidents
		{
			get
			{
				return this.GetRelatedEntity<DataverseModel.Subject>("subject_incidents", null);
			}
			set
			{
				this.SetRelatedEntity<DataverseModel.Subject>("subject_incidents", null, value);
			}
		}
	}
}
