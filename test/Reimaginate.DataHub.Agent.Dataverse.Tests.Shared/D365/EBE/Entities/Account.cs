...
namespace DataverseModel
{
	...
	public partial class Account : Microsoft.Xrm.Sdk.Entity
	{
		...
		public System.Collections.Generic.IEnumerable<DataverseModel.CustomerAddress> Account_CustomerAddress
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntities<DataverseModel.CustomerAddress>("Account_CustomerAddress", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.SetRelatedEntities<DataverseModel.CustomerAddress>("Account_CustomerAddress", null, value);
			}
		}
